...
.. figure:: /_static/images/colorsofmagic-wheel-2.png

Mana
---- 

Mana is everywhere, in different quantities or flow potencies. Mana is hidden from sight, but spellcasters and those attuned to the Arcane can feel it flowing through everything around them. Magic is like a spectrum of energies, and each Mana color is a representation of it. Mana of a color can be made to flow more or less intensely by altering the physical or emotional properties of a place. At the same time, an increase in the flow of a particular color of Mana in a location can permeate and affect the state of things and the feelings of individuals there. For example, a crowd that is bolstered to be angered or violent could increase the flow of Red Mana in that location, and a wizard channeling Red Mana could indirectly make the people of the place more prone to rage, spontaneity, impulsive actions, etc. In short, Mana is affected by, and affects everything in a location, reciprocally.

The GM can ascertain which colors of Mana are more or less abundant in a place or scene by thinking about the themes, mood, emotions and flavor of the situation and its inhabitants. If Mana of a specific color is scarce in the scene, Spellcasting characters might not be able to cast spells (or do so at a Disadvantage) at the GM’s discretion. Channeling Mana into a Spell exhausts it to a trickling amount, but as stated above, if the consequences or outcomes of the spell promote or bolster emotions or concepts related to that Mana Color’s domain, it might reflow and recycle itself throughout the area. Magic is not a zero-sum game; it is unpredictable.
...
A Spell might require 2 or more Colors of Mana, depending on its concepts (specially if the Spell is somewhat complex in its nature or desired outcome). When this happens, the Spellcaster needs to be skilled in each Color (see the skills section below), and either the lowest skill level is considered for the Spellcasting action, or an average of each skill must be used (at GM’s discretion, depending on the “weight” of each color in the spell).
...
* You need to channel vast amounts of Mana of [X] color(s)
