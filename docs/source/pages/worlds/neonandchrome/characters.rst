...
.. csv-table:: Programs
 ...
 "**OVERHEAT**: Target’s tech/cyberware cooling systems stop working and they receive heat damage or turn off for safety.","1 K฿"
 "**PACIFY**: All target device/Neuralink’s actions are restricted to non-violent/non-offensive.","2 K฿"
 "**PING**: Reveals target’s and nearby devices’ locations. More 'depth' takes exponentially longer.","1 K฿"
 ...
 "**SHIELD**: Passively protect against direct virtual attacks or malware injection attempts (advantage against such actions).","1 K฿"
 ...
 "**VIRUS**: Install on device; provokes a ``Malfunctioning (Mild)`` Condition and slowly propagates to nearby targets over time.","2 K฿"
